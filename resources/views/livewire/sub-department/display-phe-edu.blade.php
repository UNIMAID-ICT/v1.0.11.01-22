<div>
    <div class="my-0 space-y-3">
        ...
        <div class="flex flex-wrap space-x-3">
            ...
            @endif hover:text-white hover:bg-blue-200  rounded-md shadow-sm cursor-pointer sm:px-3" wire:click="$set('phe', 117)"> Physical Education</div>
            <div class="px-1 pl-1  @if ($active == 130)
            bg-blue-300 text-white
            @else
            bg-gray-100 text-gray-500
            @endif hover:text-white hover:bg-blue-200 rounded-md shadow-sm cursor-pointer sm:px-3" wire:click="$set('he', 130)"> Health Education</div>

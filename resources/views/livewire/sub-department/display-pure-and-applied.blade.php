<div>
    <div class="my-3 space-y-3">
        ...
        <div class="flex flex-wrap space-x-3">
            <div class="px-1 pl-1
            @if ($active == 47) bg-blue-300 text-white @else bg-gray-100 text-gray-500
            @endif hover:text-white hover:bg-blue-200  rounded-md shadow-sm cursor-pointer sm:px-3" wire:click="$set('chem', 47)">CHEMISTRY</div>

            <div class="px-1 pl-1  @if ($active == 48) bg-blue-300 text-white @else bg-gray-100 text-gray-500
            @endif hover:text-white hover:bg-blue-200 rounded-md shadow-sm cursor-pointer sm:px-3" wire:click="$set('ind', 48)">INDUSTRIAL CHEMISTRY</div>

            <div class="px-1 pl-1  @if ($active == 105) bg-blue-300 text-white @else bg-gray-100 text-gray-500
            @endif hover:text-white hover:bg-blue-200 rounded-md shadow-sm cursor-pointer sm:px-3" wire:click="$set('petch', 105)">PETROLEUM CHEMISTRY</div>
        </div>

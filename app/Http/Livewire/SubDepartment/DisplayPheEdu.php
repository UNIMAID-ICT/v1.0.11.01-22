...
class DisplayPheEdu extends Component
{
    ...
    public function updatedPhe($value){
    ...
    public function updatedHe($value){
    ...
    {
        return view('livewire.sub-department.display-phe-edu');
    }
}

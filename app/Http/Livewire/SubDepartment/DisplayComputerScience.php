...
class DisplayComputerScience extends Component
{
    ...
    public function updatedComputer($value){
    ...
    public function updatedMath($value){
    ...
    {
      return view('livewire.sub-department.display-computer-science');
    }
}

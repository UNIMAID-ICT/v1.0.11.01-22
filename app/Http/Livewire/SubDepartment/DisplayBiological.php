...
class DisplayBiological extends Component
{
    ...
    public function updatedbotany($value){
    ...
    public function updatedBiological($value){
    ...
    public function updatedZoo($value){
    ...
    {
        return view('livewire.sub-department.display-biological');
    }
}
